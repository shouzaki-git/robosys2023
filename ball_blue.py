...
cv2.createTrackbar("H_l", "trackbar", 91, 180, nothing)
cv2.createTrackbar("H_h", "trackbar", 130, 180, nothing)
cv2.createTrackbar("S_l", "trackbar", 57, 255, nothing)
...
def pick_up_ball():
    ...
    while True:
        ...
        img_color_blue = cv2.Canny(img_color_blue, threshold1, threshold2) #o
        
        cimg3 = img_color_blue
        ...
        circles1 = cv2.HoughCircles(img_color_blue, cv2.HOUGH_GRADIENT, 1, mindist, param1=pra1, param2=pra2, minRadius=minRad, maxRadius=maxRad)
        ...
        cv2.imshow('bluemask',cimg2)
        cv2.imshow('blue', cimg3)
